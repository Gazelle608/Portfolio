...
.highlight {
  background: linear-gradient(135deg, #f0e6b2 0%, var(--accent) 100%);
...
.line::after {
  ...
  position: absolute;
  inset: 0;
  background: linear-gradient(90deg, rgba(212, 175, 55, 0.28), transparent 70%);
  opacity: 0.7;
}
...
.star::before {
  ...
  inset: -4px;
  border-radius: 50%;
  background: radial-gradient(circle, rgba(212, 175, 55, 0.25), transparent 50%);
}
